				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2 transmitv">
						<div class="product-image2">
							<a href="<?=base_url('User_controller/allproducts/'.$cat->cat_id)?>">
								<img class="pic-1 img-fluid" src="<?=base_url('Assets/Admin/category/'.$cat->cat_image)?>"style=width:250px;height:250px>
								<img class="pic-2 img-fluid" src="<?=base_url('Assets/Admin/category/'.$cat->cat_image)?>">
							</a>
							<ul class="social">
						...
						<div class="product-content">
							<h3 class="title"><a href="#"><?=$cat->cat_name?> </a></h3>
