        ...
        <div class="row top-map">
          <div class="col-lg-6 partners">
            <div class="cont-details">
              ...
              <p class="margin-top"><span class="texthny">Call Us : </span> <a href="">+(91)
                  123 456 7899</a></p>
              <p> <span class="texthny">Email : </span> <a href="">
                  QuickShop@gmail.com</a></p>
              <p class="margin-top"> Palace Rd, Chembukkav, Thrissur, Kerala 680020</p>
            </div>
            <div class="hours">
              ...
              <h6 class="margin-top">Office Timing:</h6>
              <p> Monday to Friday 8.00 am - 6.00 pm</p>
      ...
      <div class="layer section-gap py-5">
        <div class="container py-lg-5">
          <div class="form">
            ...
            <form action="<?=base_url('Admin_controller/complaint')?>"class="mt-md-5 mt-4" method="post">
