...
<div class="w3layouts-main">
	<h2>Register Now</h2>
		<form action="<?=base_url('Admin_controller/admin_register')?>" method="post">
			<input type="text" class="ggg" name="name" placeholder="NAME" required="">
			<input type="email" class="ggg" name="email" placeholder="E-MAIL" required="">
			<input type="password" class="ggg" name="Password" placeholder="PASSWORD" required="">
			<input type="password" class="ggg" name="confirm" placeholder="CONFIRM PASSWORD" required="">
			<h4><input type="checkbox" />I agree to the Terms of Service and Privacy Policy</h4>
			
				<div class="clearfix"></div>
				<input type="submit" value="submit" name="button">
		</form>
		<p>Already Registered.<a href="<?=base_url('Admin_controller/login')?>">Login</a></p>
</div>
</div>
